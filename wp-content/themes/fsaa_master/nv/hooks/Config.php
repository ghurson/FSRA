...
class Config {
	...
	public static function enqueue_assets() {
		...
		wp_enqueue_style('fancybox_style', '//cdnjs.cloudflare.com/ajax/libs/fancybox/2.1.5/jquery.fancybox.css');
		wp_enqueue_style('rr_style', NV_CSS . '/rr_style.css');
		...
		wp_enqueue_script('cycle2', '//cdnjs.cloudflare.com/ajax/libs/jquery.cycle2/20140415/jquery.cycle2.min.js', array('jquery'), false, true);
		wp_enqueue_script('fancybox', '//cdnjs.cloudflare.com/ajax/libs/fancybox/2.1.5/jquery.fancybox.min.js', array('jquery'), false, true);
	}
